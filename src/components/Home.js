      ...
      <div className="header__content">
        <div className="header_hiAndIntro">
          <div className="header_hi">
            <h1 className="border-gradient border-gradient-blue">Hey</h1>
          </div>
          {/* --------------------- */}
          <div className="header_intro">
            <h2 className="border-gradient border-gradient-yellow">
              , I'm Sagar
            </h2>
          </div>
        </div>
        ...
        <div className="header_work">
          <p className="border-gradient border-gradient-deepYellow header_work_1">
            React Developer
          </p>
          {/* --------------------- */}
          <p className="border-gradient border-gradient-pink header_work_2">
            Solidity Beginner
          </p>
          {/* --------------------- */}
